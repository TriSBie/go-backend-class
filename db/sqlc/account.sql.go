...
func (q *Queries) AddMoneyToAccount(ctx context.Context, arg AddMoneyToAccountParams) (Account, error) {
	row := q.queryRow(ctx, q.addMoneyToAccountStmt, addMoneyToAccount, arg.Balance, arg.ID)
	var i Account
	err := row.Scan(
		&i.ID,
		&i.Owner,
...
func (q *Queries) UpdateAccountBalance(ctx context.Context, arg UpdateAccountBalanceParams) (Account, error) {
	row := q.queryRow(ctx, q.updateAccountBalanceStmt, updateAccountBalance, arg.Balance, arg.ID)
	var i Account
	err := row.Scan(
		&i.ID,
		&i.Owner,
